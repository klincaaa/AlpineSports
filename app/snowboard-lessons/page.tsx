...
import styles from "./SnowboardLessons.module.css";


export default function SnowboardLessons() {
    return (
        <>
            <HeroJustText
                text="SB PRIVATE LESSONS"
            />
            ...
            <section className={styles.pricing}>
                ...
                <div className={styles.cards}>
                    ...
                    <div className={styles.card}>
                        <h2>Full Day (1-3 guests)</h2>
                        <p className={styles.price}>CHF 520 / CHF 590</p>
